...
namespace AGLatency.PageTemplate
{
    ...
    public class HtmlPageOutput 
    {
        ...
        public static string reportOutputFolder = "";
        ...
        public static void AddMenuEntry(string menuTitle, string group, string shortFileName)
        {
            ...
            try
            {
                string outputPath = PageTemplate.HtmlPageOutput.reportOutputFolder;// Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location);

                string reportsFolder = outputPath + "/reports";// Path.Combine(outputPath, "data");
            ...
            {
                Logger.LogMessage("[ERROR]AddMenuEntry:" + ex.Message);
            }
...
//                string outputPath = Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location);
            ...
            {
                Logger.LogMessage("[ERROR]CreateHtmlFile:" + ex.Message);
            }
        ...
        public void SavePageToDisk()
        {
            ...
            {
                Logger.LogMessage("[ERROR]SavePageToDisk:[" + page.pageTitle + "] " + ex.Message);
            }
