...
using HkDebugTypes;
using SqlDebugTypes;
using SqlCsScripts.Common;
using SqlCsScripts.Extensions;
using SqlCsScripts.Scripts;

namespace SQLDumpViewer
{
    ...
    public static class OutputProcessor
    {
        ...
        public static string GetFieldForHtmlTable<T>(T element, FieldInfo f) where T : class
        {
            ...
            {
                columDataStr = "";
                SQLHelper.LogMessage("OutputProcessor:fileds:" + name + ", " + ex.Message);
            }
        ...
        public static String GetFieldStr<T>(T element, FieldInfo f) where T : class
        {
            ...
            {
                columDataStr = ""; SQLHelper.LogMessage("OutputProcessor:fileds:" + name + ", " + ex.Message);
            }
        ...
        public static List<int> GetColumnMaxWidth<T>(IEnumerable<T> collection) where T : class
        {
            ...
            foreach (T element in collection)
            {
                ...
                for (var i = 0; i < fields.Length; i++)
                {
                    ...
                    {
                        SQLHelper.LogMessage("[ERROR]:GetColumnMaxWidth" + e.Message);
